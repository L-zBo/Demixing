...
def main() -> None:
    ...
    parser.add_argument("--manifest-csv", type=Path, default=ROOT / "outputs/preprocessing/dataset_preprocessed_v1/_reports/quality_manifest.csv")
    ...
    dataset = RamanSpectrumDataset(args.data_root, args.manifest_csv, use_normalized=False, min_quality_tier="C")
